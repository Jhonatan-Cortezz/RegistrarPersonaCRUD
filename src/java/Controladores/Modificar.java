...
public class Modificar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       String dui_persona = request.getParameter("txtDui");
       String apellidos_persona = request.getParameter("txtApellidos");
       String nombres_persona = request.getParameter("txtNombres");
       
       
       Persona pers = new Persona();
       pers.setDui_persona(dui_persona);
       pers.setApellidos_persona(apellidos_persona);
